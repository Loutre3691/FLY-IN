...
### 10. visuel (pygame)
        - calculer un facteur d'échelle dynamiquement ✅
        - scale les images (pygame.transforme.scale) pour s adapter a la fenetre:
                - donner le role de chaque station (zone) 
                - donner une couleur et gerer le visuel autour des stations ✅
                - integrer esquie
                - integrer case avec ecrit ppur no station et eventuellemt si on clik sur la zone quon voit afficher
                - un panneau avec genre dedans zone, color, coord, et max capacite et nombre actuel de drone
        - modifier les images pour que le fonds des stations soit enlever comme esquie ✅
